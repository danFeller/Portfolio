...
const Hero = () => {
    return(
        <section className="m-20 w-full mx-auto px-0.5 xsm:max-w-screen-xsm sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
            <div className="flex flex-col items-center text-center gap-6 md:flex-row-reverse md:justify-between md:text-left md:gap-20 lg:gap-x-32 xl:gap-64 2xl:gap-96">
