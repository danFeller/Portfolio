    ...
    return(
        <section id="Contact" className=' m-16 w-full mx-auto px-0.5 xsm:max-w-screen-xsm sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl'>
            <div className="flex flex-col gap-4 text-center items-center">
                ...
                <p className="text-center w-96 2xsm:text-sm">Want to get in touch with me? You can message me on LinkedIn or directly email me. You can also check out my projects on Github here as well.</p>
